...
## Corpus Check
- 94 files · ~35,198 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 784 nodes · 2089 edges · 52 communities (30 shown, 22 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 286 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b04a7afd`
...
Cohesion: 0.12
Nodes (5): AppPropertiesTest, ComparisonExecuteIntegrationTest, ComparisonResultsIntegrationTest, org.junit.jupiter.api.DisplayName, org.junit.jupiter.api.Test
...
Cohesion: 0.07
Nodes (12): DatasetColumns, ComparisonRecord, MismatchDetail, MissingDetail, ComparisonServiceTest, ExcelReportServiceTest, jakarta.persistence.Entity, jakarta.persistence.Table (+4 more)
...
### Community 15 - "DuckDbService"
Cohesion: 0.16
Nodes (8): ComparisonResult, ComparisonEngine, ComparisonService, DuckDbService, java.sql.ResultSet, java.sql.Statement, org.slf4j.Logger, org.springframework.stereotype.Service

### Community 16 - "ToleranceConfigComponent"
Cohesion: 0.26
Nodes (4): ToleranceConfig, ToleranceConfigComponent, ToleranceItem, Component

### Community 18 - "ComparisonStatus"
Cohesion: 0.08
Nodes (43): ComparisonExecuteRequest, Deserializer, Override, ComparisonRequest, UploadResponse, ComparisonStatus, COMPARING, COMPLETED (+35 more)

### Community 19 - "FileParserService"
Cohesion: 0.09
Nodes (10): DelimiterDetector, Override, ParquetRowWriter, FileParserService, Override, PostgresJdbcConnectionProvider, DelimiterDetectorTest, java.sql.Connection (+2 more)
...
Cohesion: 0.16
Nodes (12): ComparisonController, HealthController, HealthResponse, ComparisonSummary, DatasetColumns, PagedResult, jakarta.servlet.http.HttpServletResponse, org.springframework.http.ResponseEntity (+4 more)
...
Cohesion: 0.27
Nodes (4): SseEmitter, ProgressService, org.springframework.web.servlet.mvc.method.annotation.SseEmitter, ProgressUpdate

### Community 40 - "AppProperties"
Cohesion: 0.16
Nodes (12): AppProperties, CleanupProperties, ComparisonProperties, StorageProperties, UploadProperties, ComparisonService, ObjectMapper, ObjectMapper (+4 more)

### Community 41 - "SqlDataSourceService"
Cohesion: 0.31
Nodes (4): JdbcConnectionProvider, SqlDataSourceService, SqlDataSourceServiceTest, FunctionalInterface

### Community 42 - "UploadConfigRequest"
Cohesion: 0.13
Nodes (5): MismatchDetail, MissingDetail, UploadConfigRequest, com.fasterxml.jackson.annotation.JsonInclude, com.fasterxml.jackson.annotation.JsonProperty
...
- **Why does `ComparisonRecord` connect `ComparisonRecord` to `ComparisonController.java`, `ComparisonStatus`, `ExcelReportService`, `DuckDbService`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `DuckDbService` connect `DuckDbService` to `FileParserServiceTest`, `ComparisonRecord`, `AppProperties`, `.compare`, `SqlDataSourceService`, `.getColumnHeaders`, `FileParserService`, `ExcelReportService`, `ComparisonController.java`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `AppProperties` connect `AppProperties` to `org.junit.jupiter.api.DisplayName`, `ComparisonRecord`, `ProgressService`, `DuckDbService`, `ProgressServiceTest`, `ComparisonStatus`, `ExcelReportService`, `ComparisonController.java`?**
